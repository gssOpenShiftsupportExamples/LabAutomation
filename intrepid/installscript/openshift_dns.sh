#!/bin/bash -x
#### DNS Pegasus ######
CONF_DOMAIN="intrepid.com"
CONF_NAMED_HOSTNAME="dns.intrepid.com"
CONF_ACTIVEMQ_HOSTNAME="services1.intrepid.com"
CONF_DATASTORE_HOSTNAME="services1.intrepid.com"
CONF_ACTIVEMQ_REPLICANTS="services1.intrepid.com,services2.intrepid.com,services3.intrepid.com"
CONF_NAMED_IP_ADDR=10.10.73.52
CONF_DATASTORE_REPLICANTS="services1.intrepid.com:27017,services2.intrepid.com:27017,services3.intrepid.com:27017"
CONF_INSTALL_COMPONENTS="named"

CONF_INSTALL_METHOD="none"
CONF_KEEP_HOSTNAME=true
CONF_MCOLLECTIVE_USER="mcollective"
CONF_MCOLLECTIVE_PASSWORD="redhat"
CONF_MONGODB_BROKER_USER="openshift"
CONF_MONGODB_BROKER_PASSWORD="redhat"
CONF_MONGODB_ADMIN_USER="admin"
CONF_MONGODB_ADMIN_PASSWORD="redhat"
CONF_VALID_GEAR_SIZES="small,medium"
CONF_ACTIVEMQ_ADMIN_PASSWORD="redhat"
CONF_ACTIVEMQ_AMQ_USER_PASSWORD="redhat"

CONF_BIND_KEY="14mtlM+km934L9JiMZ4b5q9Y+ZYC2wb1MeGbR7a/vnVZmRt26nOJOibpzkQpiOJNuAV0MkSahNhQk5b+SQqxRQ=="
CONF_NAMED_ENTRIES="broker:10.10.73.53,services1:10.10.73.54,services2:10.10.73.55,services3:10.10.73.56,node1:10.10.73.57,node2:10.10.73.58,node3:10.10.73.59,node4:10.10.73.60"
##########################
