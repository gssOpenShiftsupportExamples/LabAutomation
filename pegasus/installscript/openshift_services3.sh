#!/bin/bash -x
# This script includes the fix from: https://bugzilla.redhat.com/show_bug.cgi?id=1050183
...
CONF_INSTALL_COMPONENTS="datastore,activemq"

CONF_NO_DATASTORE_AUTH_FOR_LOCALHOST=false
